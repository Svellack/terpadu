  ...
  return (
    <Grid container>
      ...
      <form className={formStyle.root} noValidate autoComplete="off">
        <Grid container>
          <Grid container justifyContent="space-around" item xs={4}><br/><br/><br/></Grid>
          ...
          <Grid container alignItems="center" item xs={12}>
            ...
            <Grid item xs={1}><IconButton><EditIcon></EditIcon></IconButton></Grid>
          </Grid>
...
export default DashASalahDetail